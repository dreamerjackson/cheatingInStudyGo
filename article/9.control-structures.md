...
## 循环结构
<img width="709" alt="image" src="https://user-images.githubusercontent.com/42735226/162629614-99d58c95-21c2-4c8d-864b-3d54cfe22aa3.png">
...
在go语言中，只有for语句。可以在for循环中使用`break`语句，其立即退出循环。可以将 break 与任何 for 语句一起使用，而不仅仅是无限循环的 for 语句。
其形式如下所示:
```
for {
    // ...
